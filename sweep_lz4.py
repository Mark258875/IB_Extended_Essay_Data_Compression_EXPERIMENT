...
import yaml
import lz4
import lz4.frame as lz4frame  # bench uses lz4.frame; kept here too
...
def main():
    ...
    meta = {
        ...
        "libs": {
            ...
            "lz4": getattr(lz4, "__version__", "unknown"),
        },
    }

    # Hardware & power info (best-effort)
    try:
        meta["cpu"] = {
