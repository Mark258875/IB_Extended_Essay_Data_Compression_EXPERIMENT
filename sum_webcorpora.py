...
def main():
    ap = argparse.ArgumentParser(
        description="Summarize web corpora (standard_corpora): best/worst ratio (with % over entropy) and speed per document."
    )
    # HARD-CODED DEFAULTS for your folder layout:
    ap.add_argument("--brotli-csv", type=Path,
                    default=Path("results") / "standard_corpora" / "results_brotli.csv",
                    help="Path to Brotli CSV (default: results/standard_corpora/results_brotli.csv)")
    ap.add_argument("--lz4-csv", type=Path,
                    default=Path("results") / "standard_corpora" / "results_lz4.csv",
                    help="Path to LZ4 CSV (default: results/standard_corpora/results_lz4.csv)")
    ap.add_argument("--out-csv", type=Path,
                    default=Path("summaries") / "webcorpora_best_worst.csv",
